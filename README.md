...
| Area | What's there |
|---|---|
| Reception | WorkAdventure logo, reception desk, lounge sofas, plants and art. The **Stage** in front of the desk is an all-hands megaphone: whoever speaks there is heard by everyone standing in the reception rows in front of it. (Only that audience listens: in a listening area WorkAdventure replaces proximity video with "waiting for a speaker".) |
...
| Open office | 4 desk pods (16 desks, each a claimable personal desk), a lounge corner, and a **pool table**. You arrive (spawn) between the pool table and the lounge. Press SPACE next to the pool table to open 8-ball pool (foony.com, free, no account; "Play with Friends" gives an invite link). |
